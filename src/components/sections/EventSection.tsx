...
export function EventSection() {
  return (
    ...
    {/* Placeholder leve enquanto o mapa (pesado) do Google carrega sob demanda.
        O iframe carrega sozinho ao aproximar da tela; tocar aqui é um atalho/fallback. */}
    <button type="button" id="mapa-facade" className="mapa-facade" aria-label="Carregar o mapa do local">
    <span className="mapa-facade__pin" aria-hidden="true">
    <svg viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" /></svg>
    </span>
    <span className="mapa-facade__titulo">Carregando o mapa…</span>
    </button>
    </div>
    </div>
    </div>
